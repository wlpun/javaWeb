...
@WebServlet(name = "GetAsiaCountryServlet", value = "/GetAsiaCountryServlet")
public class GetAsiaCountryServlet extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            String sql = "select code, name, surfaceArea, population from country where continent = 'Asia'";
        ...
        response.sendRedirect(request.getContextPath() + "/asiaCountryList.jsp");
    }
